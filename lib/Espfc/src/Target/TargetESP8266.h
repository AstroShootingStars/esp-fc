...
#define ESPFC_SERIAL_1_FN (SERIAL_FUNCTION_VTX_SMARTAUDIO)
...
#define ESPFC_FEATURE_MASK (FEATURE_RX_PPM | FEATURE_MOTOR_STOP | FEATURE_GPS | FEATURE_TELEMETRY | FEATURE_DYNAMIC_FILTER)
