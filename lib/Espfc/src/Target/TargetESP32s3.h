...
#ifndef ESPFC_SERIAL_1_FN
#define ESPFC_SERIAL_1_FN (SERIAL_FUNCTION_GPS)
#endif
...
#if !defined(ESPFC_DISABLE_SERIAL_USB) || !(ESPFC_DISABLE_SERIAL_USB)
